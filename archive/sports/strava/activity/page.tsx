...
export default function StravaActivityPage() {
  ...
  const [sortBy, setSortBy] = useState<'name'|'distance'|'time'|'count'|'grade'|'elev'>('time');
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {loading && <div className="animate-pulse text-sm text-gray-400">Loading activities...</div>}
        {error && !loading && (
        ...
        {lastRideSegments && (
          <div className="mt-10">
            ...
            {segmentsLoading && <div className="text-xs text-gray-400 mb-2 animate-pulse">Loading segments...</div>}
            ...
            {lastRideSegments.length > 0 && (
              <div className="overflow-x-auto">
                ...
                <div className="flex flex-wrap gap-2 mb-2 text-[11px]">
                  {[
                    ['name','Name'],['distance','Dist'],['grade','Grade'],['time','Time'],['count','Count'],['elev','Elev'],
                  ].map(([field,label]) => (
                    <button
                      key={field}
                  ...
                  <tbody className="divide-y divide-gray-800">
                    {displayedSegments.map((effort: any) => (
                      <tr key={effort.id} className="hover:bg-gray-800/40 transition">
                        ...
                        <td className="px-3 py-2 text-gray-300">{segmentCounts[effort.segment?.id] || 0}{segmentCountFallbackRunning && (segmentCounts[effort.segment?.id]||0)===0 && ' …'}</td>
